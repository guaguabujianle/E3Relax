...
if __name__ == '__main__':
    ...
    for dataset in ['train_E3Relax', 'val_E3Relax', 'test_E3Relax']:
        if dataset == 'train_E3Relax':
            atoms_ids = train_atoms_ids
            db_path = os.path.join(data_root, 'train_E3Relax')
        elif dataset =='val_E3Relax':
            atoms_ids = val_atoms_ids
            db_path = os.path.join(data_root, 'val_E3Relax')
        elif dataset =='test_E3Relax':
            atoms_ids = test_atoms_ids
            db_path = os.path.join(data_root, 'test_E3Relax')
